<template>
                    ...
                    <div class="card-body">
                        ...
                        <form @submit.prevent="updateProduct" class="forms-sample">
                            <div class="form-group">
                                ...
                                <input type="text" v-model="product.name" class="form-control" id="name" placeholder="Enter product type" required />
                            </div>
  
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea v-model="product.description" class="form-control" id="description" placeholder="Enter product description"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" v-model="product.color" class="form-control" id="color" placeholder="Enter product color" required />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" v-model="product.unit_price" class="form-control" id="unit_price" placeholder="Enter unit price" required />
                            </div>
  ...
  async function updateProduct() {
    try {
      ...
      await axios.post(`/api/products/${product.value.id}/update`, formData, {
